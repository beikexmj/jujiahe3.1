...
@interface CircleDetailVC ()<TableViewScrollingProtocol,XLPhotoBrowserDelegate,XLPhotoBrowserDatasource,UIActionSheetDelegate>
{
...
-(void)contentViewConfig{
    ...
    myCell = [[[NSBundle mainBundle] loadNibNamed:@"CircleCell" owner:self options:nil] lastObject];
