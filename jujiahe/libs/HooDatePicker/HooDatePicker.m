...
- (instancetype)initWithSuperView:(UIView*)superView {
    ...
    if (self = [super initWithFrame:CGRectMake(0.0, SCREENHEIGHT, SCREENWIDTH, kHooDatePickerHeight)]) {
...
- (UIView *)headerView {
    if (!_headerView) {
        ...
        _headerView.backgroundColor = RGBA(0x00a7ff, 1);
        // Button Cancel
        ...
        [cancelButton setTitleColor:RGBA(0xffffff, 1) forState:UIControlStateNormal];
        ...
        [sureButton setTitleColor:RGBA(0xffffff, 1) forState:UIControlStateNormal];
